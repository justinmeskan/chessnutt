...
if (document.getElementById("hidePanel")) {
    var matchUp = ReactDOM.render(React.createElement(MatchUp, null), document.getElementById('matchApp'));
};
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                "p",
                { id: "headText" },
                "Enter Player/Room/All to chat"
            ),
            React.createElement("input", { id: "headInput", type: "text", onChange: this.props.OnInputHeadChange })
        );
    }
}
...
class SendTheChat extends React.Component {
    render() {
        return React.createElement(
            "div",
            { id: "footFrame" },
            React.createElement("input", { id: "footInput", type: "text", value: this.props.chat, onKeyDown: this.props.onSubmitChat, onChange: this.props.footInput }),
            React.createElement(
                "span",
                { id: "closeMe" },
                "Close Chat Window"
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                "div",
                { id: "chatMain" },
                React.createElement(PickYourChatToggle, { OnInputHeadChange: this.handleHeadInput }),
                React.createElement(ChatBody, { body: this.state.body }),
                React.createElement(SendTheChat, { chat: this.state.chat, onSubmitChat: this.submitChat, footInput: this.handleFootInput })
            )
        );
    }
}
if (document.getElementById('chatApp')) {
    var chat = ReactDOM.render(React.createElement(Chat, null), document.getElementById('chatApp'));
}
class LoginWrapper extends React.Component {
    ...
    render() {
        return React.createElement(LoginForm, { name: this.state.name, password: this.state.password, changeEventName: this.inputHandlerName, changeEventPassword: this.inputHandlerPassword });
    }
}
class LoginForm extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                "label",
                { className: "pagefont fieldfont" },
                "Name"
            ),
            React.createElement("br", null),
            React.createElement("input", { className: "inpu", onChange: this.props.changeEventName, name: "name", type: "text", value: this.props.name }),
            React.createElement("br", null),
            React.createElement(
                "label",
                { className: "pagefont fieldfont" },
            ...
            React.createElement("br", null),
            React.createElement("input", { className: "inpu", onChange: this.props.changeEventPassword, type: "password", name: "password", value: this.props.password }),
            React.createElement("br", null),
            React.createElement("input", { id: "submitlogin", type: "submit", value: "Submit" }),
            React.createElement(
                "a",
                { className: "log", id: "loginbutt" },
                "Enter"
            )
        );
    }
...
if (document.getElementById('loginApp')) {
    var loginWrapper = ReactDOM.render(React.createElement(LoginWrapper, null), document.getElementById('loginApp'));
...
class SigninWrapper extends React.Component {
    ...
    render() {
        return React.createElement(SigninForm, { name: this.state.name, password: this.state.password, changeEventName: this.inputHandlerName, changeEventPassword: this.inputHandlerPassword });
    }
}
class SigninForm extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement("input", { className: "inpu", onChange: this.props.changeEventPassword, type: "password", name: "password", value: this.props.password }),
            React.createElement("br", null),
            React.createElement("input", { id: "submitsignup", type: "submit", value: "Submit" }),
            React.createElement(
                "a",
                { className: "log", id: "signupbutt" },
                "Enter"
            )
        );
    }
...
if (document.getElementById('signinApp')) {
    var signinWrapper = ReactDOM.render(React.createElement(SigninWrapper, null), document.getElementById('signinApp'));
    ...
    function init() {
        ...
        function whitePawnNorth(squarePosition, piece, calcDifference) {
            ...
            if (squarePosition.x == 9 && piece.firstMove == true && boardPositions[testVectors] !== "") {
                return false;
            } else if (squarePosition.x - .5 == 8.5 && piece.firstMove == true && boardPositions[testBlackRight]) {
        ...
        function blackPawnSouth(squarePosition, piece, calcDifference) {
            ...
            if (squarePosition.x == 7 && piece.firstMove == true && boardPositions[testVectors] !== "") {
                return false;
            } else if (squarePosition.x - .5 == 6.5 && piece.firstMove == true && boardPositions[testWhiteRight]) {
        ...
        function circleAroundTheKing(king, isking) {
            ...
            for (let i = 0; i < king.moves.length; i++) {
                let xcord = null,
                    ycord = null;
                if (parseInt(parsedCords[0]) + (king.moves[i][0] + .5) > 0 && parseInt(parsedCords[0]) + (king.moves[i][0] + .5) < 15) {
                    xcord = parseInt(parsedCords[0]) + (king.moves[i][0] + .5);
                } else xcord = null;
                if (parseInt(parsedCords[1]) + (king.moves[i][1] + .5) > 0 && parseInt(parsedCords[1]) + (king.moves[i][1] + .5) < 15) {
                    ycord = parseInt(parsedCords[1]) + (king.moves[i][1] + .5);
                } else ycord = null;
